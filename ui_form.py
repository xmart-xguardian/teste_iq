...
class Ui_XGuardian(object):
    def setupUi(self, XGuardian):
        ...
        self.label_2.setGeometry(QRect(280, 40, 211, 211))
...
"border-radius:  25px;")
        ...
        self.label_2.setPixmap(QPixmap(u"../../../Administrador/Desktop/logo_cabeca.png"))
        self.label_2.setScaledContents(True)
        self.label_2.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.label_2.setWordWrap(False)
        self.groupBox = QGroupBox(XGuardian)
        self.groupBox.setObjectName(u"groupBox")
        self.groupBox.setGeometry(QRect(210, 260, 371, 151))
...
"font: 13pt \"Verdana\";")
        ...
        self.pushButton.setGeometry(QRect(230, 60, 111, 31))
...
"}")
        ...
        self.label_spinner.setGeometry(QRect(220, 10, 121, 51))
...
"background-color: transparent;")
        ...
        self.pushButton_2.setGeometry(QRect(190, 120, 171, 21))
        self.pushButton_2.setCursor(QCursor(Qt.CursorShape.OpenHandCursor))
        self.pushButton_2.setStyleSheet(u"font: 8pt \"Segoe UI\";\n"
"font: 10pt \"Segoe UI\";\n"
"border: 1px solid white;\n"
"border-radius: 3px;")
    ...
    def retranslateUi(self, XGuardian):
        ...
        self.pushButton_2.setText(QCoreApplication.translate("XGuardian", u"Esqueceu a senha?", None))
    # retranslateUi
